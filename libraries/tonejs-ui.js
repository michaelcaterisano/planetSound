    ...
    Z.render = (t, e, n) => {
      ...
      if (
        (((t, e, n) => {
          ...
          void 0 === i &&
            (s(e, e.firstChild),
            N.set(e, (i = new _(Object.assign({ templateFactory: T }, n)))),
            i.appendInto(e)),
            i.setValue(t),
            i.commit();
  ...
  */
    ...
    class _ extends i.a {
      ...
      render() {
        ...
        <div id="container">
          <select @change=${(t) =>
            (this.selectedIndex = t.target.selectedIndex)}>
            ${this.options}
          </select>
          <div id="arrow">${x}</div>
        </div>
      ...
      class extends i.a {
        ...
        <div id="container" 
          ...
          ${t.map(
            (t) => i.b`
            <span class="slider">
              <div class="fill" style="height : ${Math.ceil(
                100 * t
              ).toString()}%"></div>
            </span>
          `
      ...
      class extends i.a {
        ...
        <div id="container" 
          ...
          <div id="circle" style="left : ${(
            100 * this.x
          ).toString()}% ; top : ${(100 * (1 - this.y)).toString()}%">
          </div>
        </div>
      `;
        }
    ...
    customElements.define(
      ...
      class extends i.a {
        ...
        <div id="container">
          ...
          <div id="number">${this.value >= 0 ? "+" : ""}${this.value.toFixed(
            0
          )} db</div>
        </div>
      `;
    ...
    customElements.define(
      ...
      class extends i.a {
        ...
        <div id="container">
          ...
          ${
            this.autoplay
              ? i.b`<tone-start-context></tone-start-context>`
              : i.b``
          }
          <div id="content">
            <slot></slot>
